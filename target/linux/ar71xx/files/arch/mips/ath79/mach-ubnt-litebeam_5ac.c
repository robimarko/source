...
*/
static void __init ubnt_litebeam_5ac__setup(void)
{
...
MIPS_MACHINE(ATH79_MACH_UBNT_LITEBEAM_5AC, "UBNT-LITEBEAM-5AC", "Ubiquiti LiteBeam 5AC", ubnt_litebeam_5ac__setup);
